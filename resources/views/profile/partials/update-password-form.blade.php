    <form method="post" action="{{ route('password.update') }}" class="space-y-6">
        ...
        <div>
            ...
            <input id="update_password_current_password" name="current_password" type="password" class="w-full border-2 border-gray-900 p-3 focus:ring-0 focus:border-primary font-medium" autocomplete="current-password" />
        ...
        <div>
            ...
            <input id="update_password_password" name="password" type="password" class="w-full border-2 border-gray-900 p-3 focus:ring-0 focus:border-primary font-medium" autocomplete="new-password" />
        ...
        <div>
            ...
            <input id="update_password_password_confirmation" name="password_confirmation" type="password" class="w-full border-2 border-gray-900 p-3 focus:ring-0 focus:border-primary font-medium" autocomplete="new-password" />
