<x-layout.public>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div class="flex flex-col md:flex-row justify-between items-end mb-12 gap-6 border-b border-gray-100 pb-6">
            <div>
                <h2 class="font-medium text-4xl text-gray-900 leading-tight uppercase tracking-tight">
                    Katalog Kostum
                </h2>
                <p class="text-gray-600 font-medium mt-2">Temukan kostum karakter favoritmu di sini.</p>
            </div>
            
            <form action="{{ route('catalog.index') }}" method="GET" class="flex flex-col sm:flex-row gap-0 w-full md:w-auto border border-gray-200 rounded-md">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            @forelse($costumes as $costume)
                <div class="bg-white border border-gray-200 rounded-md flex flex-col group relative">
                    <div class="h-80 relative overflow-hidden bg-gray-100 border-b border-gray-100">
                    ...
                    <div class="p-6 flex flex-col flex-grow justify-between bg-white group-hover:bg-white transition-colors">
                        <div>
                            ...
                            <h3 class="font-medium text-2xl text-gray-900 mb-4 leading-tight">{{ $costume->name }}</h3>
                        </div>
                        <div class="mt-auto space-y-4">
                            <p class="text-xs font-bold text-gray-900 border border-gray-200 rounded-md inline-block px-3 py-1 bg-white">SIZE: {{ strtoupper($costume->size) }}</p>
            ...
            @empty
                <div class="col-span-full text-center py-24 bg-white border border-gray-200 rounded-md flex flex-col items-center justify-center">
                    ...
                    <p class="text-2xl font-medium text-gray-900 uppercase">Kostum Tidak Ditemukan</p>
