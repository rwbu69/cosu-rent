        ...
        <nav x-data="{ open: false }" class="sticky top-0 z-50 bg-white border-b border-gray-100">
            <div class="px-6 mx-auto max-w-7xl sm:px-8 lg:px-10">
                <div class="flex justify-between h-16 relative">
                    ...
                    <div class="hidden md:flex absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 space-x-8">
                        ...
                        <a href="{{ route('about') }}" class="inline-flex items-center px-1 pt-1 border-b-2 font-medium leading-5 transition duration-150 ease-in-out {{ request()->routeIs('about') ? 'border-primary text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                            Tentang Kami
                        </a>
                        @auth
            ...
            <div :class="{'block': open, 'hidden': ! open}" class="hidden border-t border-gray-200 md:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <a href="{{ route('about') }}" class="block px-6 py-2 text-base font-medium {{ request()->routeIs('about') ? 'text-primary bg-primary/10' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }}">Tentang Kami</a>
                    @auth
                        @if(Auth::user()->role !== 'admin')
